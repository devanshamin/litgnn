...
ENV_NAME="litgnn"
PYTORCH_VERSION="2.3.0" # Similar to `pyproject.toml`
# Available versions for PyTorch 2.3.0 are 'cpu', 'cu118', 'cu121'
...
# Install PyG additional libraries - https://github.com/pyg-team/pytorch_geometric?tab=readme-ov-file#additional-libraries
